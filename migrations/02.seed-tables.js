...
const book2 = await Book.create({ title: "Orgueil et Préjugés", release_date: "1813-01-28", cover: "https://upload.wikimedia.org/wikipedia/commons/1/1e/PrideAndPrejudiceTitlePage.jpg", synopsis: "Une romance classique sur les mœurs et les préjugés dans l’Angleterre du XIXe siècle." });
const book3 = await Book.create({ title: "Wild", release_date: "2012-03-20", cover: "https://images-na.ssl-images-amazon.com/images/I/81VStYnDGrL.jpg ", synopsis: "Le récit autobiographique de Cheryl Strayed, une randonnée de 1700 km pour se reconstruire." });
const book4 = await Book.create({ title: "Veille sur elle", release_date: "2023-01-05", cover: "https://images.epagine.fr/9782378912432_1_75.jpg", synopsis: "Un roman poignant sur la mémoire, la guerre et la résilience." });
const book5 = await Book.create({ title: "Rendez-vous avec le crime", release_date: "2014-06-12", cover: "https://images.epagine.fr/9782290083246_1_75.jpg", synopsis: "Une enquête cosy dans un village anglais menée par une bibliothécaire curieuse." });
const book6 = await Book.create({ title: "Paradise Kiss", release_date: "2000-01-01", cover: "https://upload.wikimedia.org/wikipedia/en/3/3e/Paradise_Kiss_vol01_Cover.jpg", synopsis: "Un manga sur la mode, l’amour et la quête de soi dans le Tokyo branché." });
const book7 = await Book.create({ title: "NANA", release_date: "2000-05-26", cover: "https://upload.wikimedia.org/wikipedia/en/2/2e/Nana_vol1_cover.jpg ", synopsis: "Deux jeunes femmes nommées Nana, liées par le destin et les émotions dans un Tokyo vibrant." });
const book8 = await Book.create({ title: "Les Optimistes", release_date: "2019-02-07", cover: "https://images.epagine.fr/9782378910421_1_75.jpg", synopsis: "Un roman sur la mémoire, la musique et les liens familiaux à travers les générations." });
const book9 = await Book.create({ title: "Le Sympathisant", release_date: "2015-04-02", cover: "https://images-na.ssl-images-amazon.com/images/I/71vXqZxvXzL.jpg", synopsis: "Un espion vietnamien infiltré dans la communauté exilée aux États-Unis après la guerre." });
const book10 = await Book.create({ title: "Le journal de Mr Darcy", release_date: "2007-09-15", cover: "https://images-na.ssl-images-amazon.com/images/I/81xZ9ZKZKDL.jpg ", synopsis: "Une réécriture intime du classique de Jane Austen, vue par Darcy lui-même." });
const book11 = await Book.create({ title: "La petite confiserie de l’allée nocturne", release_date: "2021-11-10", cover: "https://images.epagine.fr/9782378912241_1_75.jpg", synopsis: "Un conte sucré et mystérieux dans une ruelle magique où les souvenirs prennent goût." });
const book12 = await Book.create({ title: "Impardonnable", release_date: "2015-03-12", cover: "https://images.epagine.fr/9782253179074_1_75.jpg", synopsis: "Un roman noir sur la culpabilité, le silence et les conséquences irréversibles." });
const book13 = await Book.create({ title: "Golden Kamui Tome 1", release_date: "2014-08-01", cover: "https://upload.wikimedia.org/wikipedia/en/1/1e/Golden_Kamuy_volume_1_cover.jpg ", synopsis: "Un manga d’aventure historique sur la chasse au trésor dans le Japon de l’ère Meiji." });
const book14 = await Book.create({ title: "Ernestine", release_date: "2022-09-22", cover: "https://images.epagine.fr/9782378912401_1_75.jpg", synopsis: "Une héroïne singulière dans un roman tendre et drôle sur la solitude et la liberté." });
const book15 = await Book.create({ title: "Les Sept Sœurs", release_date: "2014-12-01", cover: "https://images-na.ssl-images-amazon.com/images/I/81Zz7kq3uXL.jpg", synopsis: "Une saga familiale inspirée des constellations, pleine de mystère et de voyages." });
const book16 = await Book.create({ title: "La Servante Écarlate", release_date: "1985-09-01", cover: "https://upload.wikimedia.org/wikipedia/en/1/14/TheHandmaidsTale.jpg", synopsis: "Un roman dystopique sur la domination patriarcale et la résistance féminine." });
const book17 = await Book.create({ title: "Druss la Légende", release_date: "1993-06-01", cover: "https://images-na.ssl-images-amazon.com/images/I/91ZzZzYzZzL.jpg", synopsis: "Une épopée fantasy sur un guerrier mythique, entre honneur, combat et solitude." });
const book18 = await Book.create({ title: "Endymion", release_date: "1996-02-01", cover: "https://images-na.ssl-images-amazon.com/images/I/81ZzZzZzZzL.jpg", synopsis: "Une aventure de science-fiction dans l’univers d’Hyperion, entre poésie et technologie." });
const book19 = await Book.create({ title: "Le Seigneur des Anneaux", release_date: "1954-07-29", cover: "https://upload.wikimedia.org/wikipedia/en/8/8e/The_Lord_of_the_Rings_cover.gif ", synopsis: "La quête épique de l’Anneau unique dans un monde fantastique peuplé de héros et de ténèbres." });
const book20 = await Book.create({ title: "Conan le Sim...", release_date: "1932-01-01", cover: "https://upload.wikimedia.org/wikipedia/en/2/2e/Conan_the_Barbarian_%281982%29_poster.jpg", synopsis: "Les aventures brutales et mythiques du barbare Conan dans un monde sauvage et magique." });
